...
.bash_profile is used during login and it sources .path, .bash_prompt, .exports, .aliases, .functions, .extra
.bashrc is read everytime a new shell is started and it sources .bash_profile
